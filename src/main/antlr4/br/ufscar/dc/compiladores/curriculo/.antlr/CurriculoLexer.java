...
public class CurriculoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CURRICULO", "SECAO", "EDUCACAO", "EXPERIENCIA", "HABILIDADES", "IDIOMAS", 
			"HABILIDADE", "IDIOMA", "GRADUACAO", "POS_GRADUACAO", "TECNICO", "AVANCADO", 
			"INTERMEDIARIO", "BASICO", "TRUE", "FALSE", "NOME", "EMAIL", "TELEFONE", 
			"ENDERECO", "LINKEDIN", "GITHUB", "INSTITUICAO", "CURSO", "NIVEL", "INICIO", 
			"FIM", "CONCLUIDO", "NOTA", "EMPRESA", "CARGO", "ATUAL", "DESCRICAO", 
			"TECNOLOGIAS", "CATEGORIA", "ABRE_CHAVE", "FECHA_CHAVE", "DOIS_PONTOS", 
			"PONTO_VIRGULA", "VIRGULA", "ABRE_COL", "FECHA_COL", "STRING", "NUM_INT", 
			"NUM_REAL", "IDENT", "WS", "COMENTARIO"
		};
	}
	...
	public CurriculoLexer(CharStream input) {
		super(input);
